    ...
    <section id="contact" class="wow fadeIn border-top border-bottom border-transperent-white-light animated"
        ...
        <div class="container">
            <div class="row">
                ...
                <span
                    class="alt-font text-uppercase title-extra-large deep-orange-text letter-spacing-1 font-weight-600">Lathis</span>
                    <span class="text-large letter-spacing-1 margin-one display-block text-uppercase light-gray-text alt-font">Get in touch with us</span>
                </div>
                <!-- end section title -->
                <img src="brando\images\void.jpg">
