...
@section('content')
    <body class="page-template-default page page-id-255 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                ...
                <div class="container">
                    ...
                    <div class="menu_container"><span class="close_menu">&times;</span>
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1764" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-255 current_page_item menu-item-1764 active"><a title="Contact" href="https://plethorathemes.com/healthflex/contact/">Contact</a></li>
        ...
        <div class="main foo" data-colorset="foo"><section class="vc_row wpb_row vc_row-fluid no_padding">
                    ...
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-6 secondary_section margin_bottom_grid boxed_plus">
                            <div class="wpb_wrapper">
                                <div class="vc_empty_space"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div role="form" class="wpcf7" id="wpcf7-f5-p255-o1" lang="en-US" dir="ltr">
                                    <div class="screen-reader-response"></div>
                                    <form action="/healthflex/contact/#wpcf7-f5-p255-o1" method="post" class="wpcf7-form demo" novalidate="novalidate">
                                        ...
                                        <p><button class="btn btn-primary wpcf7-response-output wpcf7-display-none">SEND</button></p>
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div  class="wpb_single_image wpb_content_element vc_align_left">
                                    ...
                                    <figure class="wpb_wrapper vc_figure">
                                        <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="103" height="100" src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/icon_med_book.png" class="vc_single_image-img attachment-medium" alt="" /></div>
                                    </figure>
                                </div>
            ...
            <section style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/facilities_7.jpg')" class="vc_row wpb_row vc_row-fluid secondary_section text-center transparent_film bgimage bg_vcenter">
                <div class="container">
                    <div class="row">
