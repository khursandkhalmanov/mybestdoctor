...
@section('content')
    <body class="page-template-default page page-id-532 page-parent theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                ...
                <div class="container">
                    ...
                    <div class="menu_container"><span class="close_menu">&times;</span>
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1760" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-532 current_page_item menu-item-1760 active"><a title="Departments" href="https://plethorathemes.com/healthflex/departments/">Departments</a></li>
        ...
        <div class="head_panel">
            <div style="background-image: url(https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/facilities_5.jpg)" class="full_width_photo   ">
        ...
        <div class="main foo" data-colorset="foo"><section class="vc_row wpb_row vc_row-fluid no_padding vbottom">
                <div class="container">
                    <div class="row">
                        <div style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/10/cosmetic.jpg')" class="wpb_column vc_column_container col-sm-6 secondary_section transparent_film boxed_plus same_height_col vc_custom_1475574607347 bg_vcenter">
                        ...
                        <div class="wpb_column vc_column_container col-sm-6 boxed_plus same_height_col">
                            <div class="wpb_wrapper">
                                <div class="vc_empty_space"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div class="vc_empty_space  hidden-xs"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div class="section_header subtitle_bottom   vc_custom_1468406213693 fancy text-left">

                                    <h3>Cosmetic Surgery Department</h3>


                                    <p >Specialized in Rhinoplasty</p>
                                </div>
                                ...
                                <div class="plethora_button wpb_content_element   text-left ">
                                    <a href="http://plethorathemes.com/healthflex/departments/cosmetic-surgery/" debug class=" btn btn-secondary  " title=""  target="_self">
                    ...
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-3 col-xs-6 skincolored_section boxed same_height_col vc_custom_1448045388925">
                            <div class="wpb_wrapper">
                                ...
                                <div  class="wpb_single_image wpb_content_element vc_align_center  vc_custom_1468406448468">

                                    <figure class="wpb_wrapper vc_figure">
                                        <div class="vc_single_image-wrapper vc_box_circle  vc_box_border_grey"><img class="vc_single_image-img " src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/11/nurse_1-80x80.jpg" width="80" height="80" alt="A female doctor with a folder, standing isolated on white background" title="A female doctor" /></div>
                                    </figure>
                                </div>
                                <!-- ========================== TEASER BOX ==========================-->
                                <div class="teaser_box wpb_content_element text-center  transparent      ">



                                    <a href="http://plethorathemes.com/healthx/departments/cosmetic-surgery/" debug title="" target="">
                                ...
                                <div class="teaser_box wpb_content_element text-center        ">
                                    ...
                                    <div class="figure ">
                                        ...
                                        <a href="http://plethorathemes.com/healthflex/departments/cosmetic-surgery/" debug title="" target="">
                                            ...
                                            <i class="wmi icon-i-family-practice"></i>
            ...
            <section class="vc_row wpb_row vc_row-fluid no_padding">
                <div class="container">
                    <div class="row">
                        <div style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/slider-4.jpg')" class="wpb_column vc_column_container col-sm-6 secondary_section transparent_film boxed_plus same_height_col vc_custom_1475574629907 bg_vcenter">
                            <div class="wpb_wrapper">
                        ...
                        <div class="wpb_column vc_column_container col-sm-6 boxed_plus same_height_col">
                            <div class="wpb_wrapper">
                                <div class="vc_empty_space"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div class="vc_empty_space  hidden-xs"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div class="section_header subtitle_bottom   vc_custom_1468406222998 fancy text-left">

                                    <h3>Microbiology Lab</h3>


                                    <p >High-end equipment at your service</p>
                                </div>
                                <div class="wpb_text_column wpb_content_element " >
                                    <div class="wpb_wrapper">
                                        <p>I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
            ...
            <section class="vc_row wpb_row vc_row-fluid no_padding">
                <div class="container">
                    <div class="row">
                        <div style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/10/bigstock-Pregnant-belly-of-young-woman-49223903.jpg')" class="wpb_column vc_column_container col-sm-6 dark_section transparent_film boxed_plus same_height_col vc_custom_1475574641987 bg_vcenter">
                            <div class="wpb_wrapper">
                        ...
                        <div class="wpb_column vc_column_container col-sm-6 boxed_plus same_height_col">
                            <div class="wpb_wrapper">
                                <div class="vc_empty_space"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div class="vc_empty_space  hidden-xs"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div class="section_header subtitle_bottom   vc_custom_1468406233739 fancy text-left">

                                    <h3>Gynaecology &amp; Birth</h3>


                                    <p >Specialized alternative care</p>
                                </div>
                                <div class="wpb_text_column wpb_content_element " >
                                    <div class="wpb_wrapper">
                                        <p>I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
