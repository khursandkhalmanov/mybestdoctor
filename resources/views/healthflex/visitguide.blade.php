...
@section('title', 'Visit guide')
@section('content')
    <body class="page-template-default page page-id-1255 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                    ...
                    <div class="menu_container"><span class="close_menu">&times;</span>
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1674" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1674 lihasdropdown"><a title="Info" href="#">Info  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    <li id="menu-item-1792" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1255 current_page_item menu-item-1792 active"><a title="The Patient&#039;s &amp; Visitor&#039;s Guide" href="https://plethorathemes.com/healthflex/visit-guide/">The Patient&#8217;s &#038; Visitor&#8217;s Guide</a></li>
        ...
        <div class="main foo" data-colorset="foo"><section style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2013/06/health_clinic_outside.jpg')" class="vc_row wpb_row vc_row-fluid secondary_section transparent_film bgimage bg_vcenter">
                <div class="container">
                    <div class="row">
            ...
            <section style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/help_desk.jpg')" class="vc_row wpb_row vc_row-fluid secondary_section transparent_film bgimage parallax-window bg_vcenter">
                <div class="container">
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-12">
                            <div class="wpb_wrapper">
