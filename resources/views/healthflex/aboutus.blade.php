...
@section('content')
    ...
    <body class="page-template-default page page-id-166 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="/">Home</a></li>
                            <li id="menu-item-1673" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1673 lihasdropdown"><a title="Our Clinic" href="#">Our Clinic  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    <li id="menu-item-1758" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-166 current_page_item menu-item-1758 active"><a title="About Us" href="/aboutus">About Us</a></li>
        ...
        <div class="head_panel">
            <div style="background-image: url(https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/slider-6.jpg)" class="full_width_photo bg_vtop parallax-window ">
        ...
        <div class="main foo" data-colorset="foo"><section class="vc_row wpb_row vc_row-fluid">
                <div class="container">
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-12 col-md-6 margin_bottom_grid">
                            <div class="wpb_wrapper">
                                ...
                                <div class="wpb_text_column wpb_content_element " >
                                    <div class="wpb_wrapper">
                                        <p>Our team strives to achieve excellence in every aspect of the production process, from the preliminary hand-drawn sketches to the aftersales support. We carefully design our themes to be easy and flexible while making sure that most FAQ of our customers can be answered by our detailed documentation.</p>
                                ...
                                <div class="wpb_text_column wpb_content_element " >
                                    <div class="wpb_wrapper">
                                        <p>We focus on using the latest web standards and practices regarding UX guidelines and WordPress theme development and strongly encourage our customers to follow us on this. The use of a child theme and the plugin-based development of ©Plethora Framework ensure hassle-free updates and peace of mind.</p>
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div class="wpb_video_widget wpb_content_element vc_clearfix   vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-left" >
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_video_wrapper"><iframe style="border:none;" src="https://player.vimeo.com/video/67157062" width="500" height="281"  title="Become A Health Coach" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
                                    </div>
                                </div>
                        ...
                        <div class="wpb_column vc_column_container col-sm-12 white_section text-left">
                            <div class="wpb_wrapper">
                                <div class="vc_empty_space"   style="height: 32px"><span class="vc_empty_space_inner"></span></div>
                                <div class="wpb_text_column wpb_content_element  text-center" >
                                    <div class="wpb_wrapper">
                                        <p><img class="alignnone size-full wp-image-1111" src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/logo_abim.png" alt="logo_abim" width="218" height="75" />                <img class="alignnone wp-image-1110 size-full" src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/logo_aap.png" alt="logo_aap" width="218" height="75" />                <img class="alignnone size-full wp-image-1109" src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/logo_aafp.png" alt="logo_aafp" width="218" height="75" />        <img class="alignnone size-full wp-image-1112" src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/logo_nrha.png" alt="logo_nrha" width="218" height="75" />.</p>
            ...
            <section id="facilities" class="vc_row wpb_row vc_row-fluid light_section separator_bottom sep_angled_positive_bottom">
                <div class="container">
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-12 text-center">
                            <div class="wpb_wrapper">
                                <div class="section_header subtitle_bottom   fancy text-left">
                                    ...
                                    <h2 style="text-align: left;">Facilities</h2>


                                    <p >We constantly invest in high-end equipment</p>
                                </div>
                            </div>
                        </div>
                        <div class="wpb_column vc_column_container col-sm-12 col-md-6 margin_bottom_grid">
                            <div class="wpb_wrapper">
                                <div class="pl_fixed_ratio_media  ">
                                    <div class="stretchy_wrapper ratio_16-9   bg_vcenter" style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2013/06/health_clinic_outside.jpg');">
                                        <img alt="" src="https://plethorathemes.com/healthflex/wp-content/uploads/2013/06/health_clinic_outside.jpg">
                                    </div>
                        ...
                        <div class="wpb_column vc_column_container col-sm-12">
                            <div class="wpb_wrapper">
                                ...
                                <div class="vc_grid-container-wrapper vc_clearfix">
                                    <div class="vc_grid-container vc_clearfix wpb_content_element vc_media_grid" data-initial-loading-animation="fadeIn" data-vc-grid-settings="{&quot;page_id&quot;:166,&quot;style&quot;:&quot;all&quot;,&quot;action&quot;:&quot;vc_get_vc_grid_data&quot;,&quot;shortcode_id&quot;:&quot;1551612584875-483ccc92-aebf-6&quot;,&quot;tag&quot;:&quot;vc_media_grid&quot;}" data-vc-request="https://plethorathemes.com/healthflex/wp-admin/admin-ajax.php" data-vc-post-id="166" data-vc-public-nonce="33cff29b69">
            ...
            <section style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/family1.jpg')" class="vc_row wpb_row vc_row-fluid secondary_section transparent_film vcenter bgimage bg_vcenter">
                <div class="container">
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-12">
                            <div class="wpb_wrapper">
                                <div class="section_header subtitle_bottom   fancy text-center">
                                    ...
                                    <h2 style="text-align: center;">We promised to take care&#8230; and delivered</h2>
                        ...
                        <div class="wpb_column vc_column_container col-sm-12 col-md-8 text-center">
                            <div class="wpb_wrapper">
                                ...
                                <div class="testimonial testimonial-slider  ">
                                    <ul class="slides" id="5e59404391de0">
                                        <li>
    ...
    <script type='text/javascript' src='https://plethorathemes.com/healthflex/wp-content/themes/healthflex/includes/core/assets/js/libs/owl.carousel.2.0.0-beta.2.4/owl.carousel.min.js?ver=2.4'></script>
    ...
    <script>
        jQuery(function($) {
            ...
            var $testimonials     = $("#5e59404391de0");
