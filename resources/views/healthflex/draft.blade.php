<body class="page-template-default page page-id-536 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
<div class="overflow_wrapper">
                    ...
                    <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                        <li id="menu-item-1673" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1673 lihasdropdown"><a title="Our Clinic" href="#">Our Clinic  </a>
                            <ul role="menu" class=" menu-dropdown">
                                ...
                                <li id="menu-item-1759" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-536 current_page_item menu-item-1759 active"><a title="Careers" href="https://plethorathemes.com/healthflex/careers/">Careers</a></li>
                            </ul>
                        </li>
        ...
        <div class="diagonal_headings_layout">
            <div class="hgroup">
                ...
                <div class="subtitle body-bg_section   ">
                    <div class="container">
                        <p>We are always looking out for skilled employees!</p>
                    </div>
                </div>
    ...
    <div class="main foo" data-colorset="foo"><section class="vc_row wpb_row vc_row-fluid separator_bottom sep_angled_positive_bottom">
            <div class="container">
                <div class="row">
                    <div class="wpb_column vc_column_container col-sm-6 col-md-8 margin_bottom_grid">
                        <div class="wpb_wrapper">
                            ...
                            <div class="wpb_text_column wpb_content_element " >
                                <div class="wpb_wrapper">
                                    <p align="left">At <strong>Medical Clinic</strong> we&#8217;re working every day to meet—or even exceed—our goal of becoming the healthcare provider of choice. We dedicate ourselves to the highest level of patient care. Each day brings new discoveries and new challenges as we fulfill our commitment to working wonders for our patients.</p>
                                    <p>This commitment to our patients requires another—to our employees. We pride ourselves on our welcoming and supportive work environment, and the opportunities we offer for training and advancement.</p>
                                    <p><strong>As an employee at Medical Clinic and Hospital, you will:</strong></p>
                                    <ul>
                                        <li>Meet amazing and inspiring people every day.</li>
                                        <li>Tap into your true potential.</li>
                                        <li>Develop your existing skills while discovering new ones.</li>
                                        <li>Find meaning in every workday.</li>
                                        <li>Return home from each shift feeling that you have truly made a difference.</li>
                                    </ul>
                                    <p align="left">At the moment there are no positions open in Medical Clinic. However, we are always interested in attracting professionals to our company and ready to consider all interesting offers. You can send your resume per email or faxwith the remark “HR department” and we will contact you if we have a position available.</p>
                    ...
                    <div class="wpb_column vc_column_container col-sm-6 col-md-4">
                        <div class="wpb_wrapper">
                            <div class="vc_separator wpb_content_element vc_separator_align_left vc_sep_width_100 vc_sep_pos_align_center vc_sep_color_grey vc_separator-has-text" ><span class="vc_sep_holder vc_sep_holder_l"><span  class="vc_sep_line"></span></span><h4>Resources Allotment</h4><span class="vc_sep_holder vc_sep_holder_r"><span  class="vc_sep_line"></span></span>
                            </div>
                            <div class="vc_chart vc_round-chart wpb_content_element" data-vc-legend="1" data-vc-tooltips="1" data-vc-animation="easeInOutCubic" data-vc-stroke-color="#ffffff" data-vc-stroke-width="2" data-vc-type="pie" data-vc-values="[{&quot;value&quot;:20,&quot;color&quot;:&quot;#6dab3c&quot;,&quot;highlight&quot;:&quot;#5f9434&quot;,&quot;label&quot;:&quot;Admin Staff&quot;},{&quot;value&quot;:30,&quot;color&quot;:&quot;#5aa1e3&quot;,&quot;highlight&quot;:&quot;#4092df&quot;,&quot;label&quot;:&quot;Doctors&quot;},{&quot;value&quot;:40,&quot;color&quot;:&quot;#b97ebb&quot;,&quot;highlight&quot;:&quot;#ae6ab0&quot;,&quot;label&quot;:&quot;Nurses&quot;},{&quot;value&quot;:10,&quot;color&quot;:&quot;#fe6c61&quot;,&quot;highlight&quot;:&quot;#fe5043&quot;,&quot;label&quot;:&quot;IT&quot;}]">

                                <div class="wpb_wrapper">
                                    <div class="vc_chart-with-legend"><canvas class="vc_round-chart-canvas" width="1" height="1"></canvas></div><ul class="vc_chart-legend"><li><span style="background-color:#6dab3c"></span>Admin Staff</li><li><span style="background-color:#5aa1e3"></span>Doctors</li><li><span style="background-color:#b97ebb"></span>Nurses</li><li><span style="background-color:#fe6c61"></span>IT</li></ul>
                                </div>
                            </div>
                            <div class="plethora_button wpb_content_element   text-left btn_block">
                                <a href="http://plethorathemes.com/healthflex/our-staff/" debug class=" btn btn-secondary  " title=""  target="_self">
        ...
        <section style="background-image: url('https://plethorathemes.com/healthflex/wp-content/uploads/2015/10/clinic_corridor.jpg')" class="vc_row wpb_row vc_row-fluid secondary_section text-center transparent_film bgimage parallax-window bg_vcenter">
            <div class="container">
                <div class="row">
                    <div class="wpb_column vc_column_container col-sm-12">
                        <div class="wpb_wrapper">
                            <div class="section_header subtitle_bottom   fancy text-center">
                                ...
                                <h2>Think you could work with us?</h2>


                                <p >Contact us with a CV to arrange an interview!</p>
                            </div><div class="plethora_button wpb_content_element   text-center ">
                                <a href="http://plethorathemes.com/healthflex/contact/" debug class=" btn btn-success with-icon " title=""  target="_self">
