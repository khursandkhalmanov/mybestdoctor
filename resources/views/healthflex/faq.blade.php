...
@section('title', 'FAQ')
@section('content')
    <body class="page-template-default page page-id-561 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 hidden-xs hidden-sm text-left">
                            <div class="top_menu_container">
                                <ul id="menu-top-bar" class="top_menu hover_menu"><li id="menu-item-1774" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-561 current_page_item menu-item-1774 active"><a title="FAQ" href="https://plethorathemes.com/healthflex/faq/">FAQ</a></li>
                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1674" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1674 lihasdropdown"><a title="Info" href="#">Info  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1768" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-561 current_page_item menu-item-1768 active"><a title="FAQ" href="https://plethorathemes.com/healthflex/faq/">FAQ</a></li>
                                </ul>
                            </li>
        ...
        <div class="main foo" data-colorset="foo"><section class="sidebar_on padding_top_half" ><div class="container"><div class="row"><div class="col-sm-8 col-md-8 main_col ">
                                ...
                                <div class="row">
                                    <div class="wpb_column vc_column_container col-sm-12 margin_bottom_grid">
                                        <div class="wpb_wrapper">
                                            <div class="vc_empty_space"   style="height: 32px"><span class="vc_empty_space_inner"></span></div><div id="1447064341323-f6ee47d8-32bf" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md vc_toggle_active"><div class="vc_toggle_title"><h4>Emergency information</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>If you are an emergency case requiring immediate attention, please call (+555) 959-595-959 or the nurse at (+555) 959-595-959. We will give you instructions and directions. If you know the Medical Centre&#8217; s address, please come as quick as possible. If you need transfer by us, please let us know by phone.</p>
                                                </div></div><div id="1447064412741-3e356338-032d" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>What can I expect at an appointment?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>When you arrive at the Medical Centre, the staff will greet you and seat you at the waiting room. We will examine you as quick as possible &#8211; average waiting time is 15 minutes.</p>
                                                </div></div><div id="1447064451796-0645cbf1-8947" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>What happens if I am a new patient?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>You may have referred yourself, have been referred by another specialist or by Medical Insurance. We will discuss your problem and ask about your medical history. A thorough examination will then follow. We may request examinations and tests to assist and support our diagnosis.</p>
                                                    <p>X-rays, blood / urine analysis, ultrasonography, MRI, endoscopy can all be performed with no delay in the same building. If you have previous examinations and tests related to your current condition, please bring those along to the consultation. Also bring any copies of letters from other doctors or recent medication. It will help us to help you.</p>
                                                    <p>We will discuss with you the results of your examinations and we will recommend the proper treatment. Some conditions may be faced immediately by conservative or surgical treatment. In case you need surgery requiring general anesthesia, we arrange routine or urgent transfer by quick boat, state or private air ambulance to Athens or to your preferred destination (subject to stable medical condition). In special cases a patient can be escorted.</p>
                                                    <p>Otherwise, depending on the results of your examinations, the nature of the medical problem and your holiday plan, we will discharge you from our clinic, refer you on to another health professional or book you for surgery. If follow-up consultation or further consultations are required, we will indicate this and the staff will let you know the date and time of your next appointment.</p>
                                                </div></div><div id="1447064507869-5e4ee3bd-a327" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>Do you have Imaging (x-rays, ultrasonography, CT-scan) facilities?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>Yes.</p>
                                                    <p>Ordinary x-rays, panoramic mouth views, ultrasonography , endoscopy, CT-scan, bone mass density scanner or laser imager ( digital developer ) can be performed on location.</p>
                                                </div></div><div id="1447064555113-315c72fb-176e" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>Do you examine children at your clinic?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>Yes.</p>
                                                    <p>A Pediatrician is immediately available if needed.</p>
                                                </div></div><div id="1447065558213-dca24fc1-47a1" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>What happens if I need an intramuscular or intravenous injection?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>Certain cases require injections for quick and full recovery. These can include antibiotics, anti-inflammators, local anesthesia or steroids.<br />
                                                        Steroids and local anesthesia injections are administered by Doctors and anti-inflammators / antibiotics by an experienced nurse under our supervision.</p>
                                                </div></div><div id="1447065583979-54e0b9c1-ae47" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>What if I need Anesthetic?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>We can undertake only small or minor procedures in our Medical Centre, using local anesthesia or superficial sedation.</p>
                                                    <p>All other procedures requiring general anesthesia are transferred to Athens or back to patient&#8217;s destination, to be admitted at a General Hospital.</p>
                                                </div></div><div id="1447065607650-fbb48814-35d7" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>What happens if I need a prescription?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>We may prescribe for example analgesia treatment for your condition. Please let us know in case you have any allergy or other medical condition.</p>
                                                    <p>If you have already been taking drugs prescribed by your home doctor, please bring them with you for clarification or possible drug interactions and correlations with the new condition.</p>
                                                </div></div><div id="1447065636406-978b4ed0-e711" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>Insurance and Billing</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p><strong>Do you accept my insurance?</strong></p>
                                                    <p>Our Medical Centre accepts most of the internationally recognized Insurance companies with affiliate.</p>
                                                    <p>If this is not your case, or if you have no insurance coverage then you will be expected to pay the bill in cash or credit card at the end of consultation. The original receipt, the signed copy of the credit card bill, the medical report in English and the results of tests performed are given to you in order to be delivered to your private or state insurance for reimbursement.</p>
                                                    <p>An estimate of consultation fees and costs, investigations or surgery are available on request.</p>
                                                    <p><strong>Do I need referral?</strong></p>
                                                    <p>If you have private insurance with an affiliate, the referral can be sent from your insurance company to us by fax or e-mail. We suggest that you contact your insurance in order to obtain this referral before your visit to our offices.</p>
                                                    <p>If you don&#8217;t have an insurance coverage, feel free to come to our Medical Centre. The billing procedure is as explained above.</p>
                                                </div></div><div id="1447065710387-d413605d-104e" class="vc_toggle vc_toggle_default vc_toggle_color_default  vc_toggle_size_md"><div class="vc_toggle_title"><h4>Do you have parking facilities?</h4><i class="vc_toggle_icon"></i></div><div class="vc_toggle_content"><p>Yes.</p>
                                                    <p>Free Parking is available in front and around the Medical Centre.</p>
                                                </div></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- END================== INFOBOX ========================--><aside id="nav_menu-1" class="widget widget_nav_menu"><h4>All Departments</h4><div class="menu-departments-container"><ul id="menu-departments" class="menu"><li id="menu-item-1776" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1776"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Cosmetic Surgery</a></li>
                                        <li id="menu-item-1777" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1777"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Gynaecology</a></li>
                                        <li id="menu-item-1778" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1778"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Diagnostic Imaging</a></li>
                                        <li id="menu-item-1779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1779"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Cardiology</a></li>
                                        <li id="menu-item-1780" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1780"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Microbiology</a></li>
                                        <li id="menu-item-1781" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1781"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Neurology</a></li>
                                        <li id="menu-item-1782" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1782"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Opthalmology</a></li>
                                        <li id="menu-item-1783" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1783"><a href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">Physiotherapy</a></li>
                                    </ul></div></aside><!-- ===================== MULTIBOX ========================-->
                            ...
                            <div class="widget plethora-multibox-widget light_section bg_vcenter  boxed  " >
                                ...
                                <div class=""><div class="text-center"><h5 class="no_margin"><a href="/healthflex/shop">Visit Our Shop!</a></h5></div></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3"><aside id="nav_menu-2" class="widget widget_nav_menu"><h4>Quick Links</h4><div class="menu-quick-links-container"><ul id="menu-quick-links" class="menu"><li id="menu-item-1784" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1784"><a href="https://plethorathemes.com/healthflex/services/">All Medical Services</a></li>
                                    ...
                                    <li id="menu-item-1786" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-561 current_page_item menu-item-1786"><a href="https://plethorathemes.com/healthflex/faq/" aria-current="page">FAQ</a></li>
