...
@section('content')
    <body class="page-template-default page page-id-564 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                        ...
                        <div class="col-md-6 col-sm-6 hidden-xs hidden-sm text-left">
                            <div class="top_menu_container">
                                <ul id="menu-top-bar" class="top_menu hover_menu"><li id="menu-item-1774" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1774"><a title="FAQ" href="https://plethorathemes.com/healthflex/faq/">FAQ</a></li>
                                    ...
                                    <li id="menu-item-1773" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-564 current_page_item menu-item-1773 active"><a title="Request an Appointment" href="https://plethorathemes.com/healthflex/appointment-booking/">Request an Appointment</a></li>
                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1674" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1674 lihasdropdown"><a title="Info" href="#">Info  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1767" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-564 current_page_item menu-item-1767 active"><a title="Appointment Booking" href="https://plethorathemes.com/healthflex/appointment-booking/">Appointment Booking</a></li>
        ...
        <div class="head_panel">
            <div style="background-image: url(https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/facilities_2.jpg)" class="full_width_photo   ">
                ...
                <div class="hgroup">
                    ...
                    <div class="subtitle body-bg_section   ">
                        <div class="container">
                            <p>Fill in the Form or call us directly at <b> (+555) 959-595-959</b></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-5">
                            <div class="wpb_wrapper">
                                <div class="vc_empty_space"   style="height: 64px"><span class="vc_empty_space_inner"></span></div><div role="form" class="wpcf7" id="wpcf7-f281-p564-o1" lang="en-US" dir="ltr">
                                    <div class="screen-reader-response"></div>
                                    <form action="/healthflex/appointment-booking/#wpcf7-f281-p564-o1" method="post" class="wpcf7-form demo" novalidate="novalidate">
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div  class="wpb_single_image wpb_content_element vc_align_left">
                                    ...
                                    <figure class="wpb_wrapper vc_figure">
                                        <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="130" height="100" src="https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/icon_help_desk1.png" class="vc_single_image-img attachment-full" alt="" /></div>
                                    </figure>
                                </div>
                                ...
                                <div class="wpb_text_column wpb_content_element " >
                                    <div class="wpb_wrapper">
                                        ...
                                        <p><strong><a href="mailto:info@plethorathemes.com">info@plethorathemesx.com</a></strong></p>
                                        <p><strong><a href="https://www.google.com/maps/place/79+Folsom+St,+San+Francisco,+CA+94105,+USA/@37.7902642,-122.3929651,17z/data=!3m1!4b1!4m2!3m1!1s0x8085807aad0a9e0b:0x378e593dff7a2ac3?hl=en">79 Folsom Ave, San Francisco, CA 94107</a></strong></p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3"><aside id="nav_menu-2" class="widget widget_nav_menu"><h4>Quick Links</h4><div class="menu-quick-links-container"><ul id="menu-quick-links" class="menu"><li id="menu-item-1784" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1784"><a href="https://plethorathemes.com/healthflex/services/">All Medical Services</a></li>
                                    <li id="menu-item-1785" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-564 current_page_item menu-item-1785"><a href="https://plethorathemes.com/healthflex/appointment-booking/" aria-current="page">Appointment Booking</a></li>
