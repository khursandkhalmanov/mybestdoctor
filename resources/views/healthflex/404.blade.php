...
@section('title', '404')
@section('content')
    <body class="error404 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1672" class="two-column dropleft menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1672 lihasdropdown"><a title="More" href="#">More  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1675" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-1675 active"><a title="Error 404 page" href="/healthflex/404">Error 404 page</a></li>
        ...
        <div class="head_panel">
            <div style="background-image: url(https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/facilities_7.jpg)" class="full_width_photo   ">
        ...
        <div class="main" ><section class="vc_off sidebar_off " ><div class="container"><div class="row"><div class="col-md-12">
                            ...
                            <div class="search_form">
                                <form role="search" method="get" name="s" id="s" action="https://plethorathemes.com/healthflex/">
    ...
    <!-- TEMPLATE PART: /themes/healthflex/404.php --></body>
@endsection
