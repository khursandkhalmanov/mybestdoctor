...
@section('content')
    <body class="page-template-default page page-id-538 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                        ...
                        <div class="col-md-6 col-sm-6 hidden-xs hidden-sm text-left">
                            <div class="top_menu_container">
                                <ul id="menu-top-bar" class="top_menu hover_menu"><li id="menu-item-1774" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1774"><a title="FAQ" href="https://plethorathemes.com/healthflex/faq/">FAQ</a></li>
                                    <li id="menu-item-1775" class="hidden menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-538 current_page_item menu-item-1775 active"><a title="Fees &amp; Insurance" href="https://plethorathemes.com/healthflex/fees-insurance/">Fees &#038; Insurance</a></li>
                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1674" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1674 lihasdropdown"><a title="Info" href="#">Info  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1756" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-538 current_page_item menu-item-1756 active"><a title="Fees &amp; Insurance" href="https://plethorathemes.com/healthflex/fees-insurance/">Fees &#038; Insurance</a></li>
            ...
            <div class="diagonal_headings_layout">
                <div class="hgroup">
                    ...
                    <div class="subtitle body-bg_section   ">
                        <div class="container">
                            <p>All you need to know about billing and coverage</p>
                        </div>
                    </div>
        ...
        <div class="main foo" data-colorset="foo"><section class="sidebar_on padding_top_half" ><div class="container"><div class="row"><div class="col-sm-8 col-md-8 main_col "><section class="vc_row wpb_row vc_row-fluid">
                                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3"><aside id="nav_menu-2" class="widget widget_nav_menu"><h4>Quick Links</h4><div class="menu-quick-links-container"><ul id="menu-quick-links" class="menu"><li id="menu-item-1784" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1784"><a href="https://plethorathemes.com/healthflex/services/">All Medical Services</a></li>
                                    ...
                                    <li id="menu-item-1787" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-538 current_page_item menu-item-1787"><a href="https://plethorathemes.com/healthflex/fees-insurance/" aria-current="page">Fees &amp; Insurance</a></li>
