...
@section('title', 'Cosmetic Surgery')
@section('content')
    <body class="page-template-default page page-id-611 page-child parent-pageid-532 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                ...
                <div class="container">
                    ...
                    <div class="menu_container"><span class="close_menu">&times;</span>
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1760" class="menu-item menu-item-type-post_type menu-item-object-page current-page-ancestor current-page-parent menu-item-1760"><a title="Departments" href="https://plethorathemes.com/healthflex/departments/">Departments</a></li>
                            ...
                            <li id="menu-item-1672" class="two-column dropleft menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1672 lihasdropdown"><a title="More" href="#">More  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1770" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-611 current_page_item menu-item-1770 active"><a title="A Department&#039;s Page" href="https://plethorathemes.com/healthflex/departments/cosmetic-surgery/">A Department&#8217;s Page</a></li>
        ...
        <div class="head_panel">
            <div style="background-image: url(https://plethorathemes.com/healthflex/wp-content/uploads/2015/10/cosmetic.jpg)" class="full_width_photo   ">
                    ...
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-8 margin_bottom_grid">
                            <div class="wpb_wrapper">
                                ...
                                <div class="vc_separator wpb_content_element vc_separator_align_left vc_sep_width_100 vc_sep_pos_align_center vc_sep_color_grey vc_separator-has-text" ><span class="vc_sep_holder vc_sep_holder_l"><span  class="vc_sep_line"></span></span><h4>Department's Services</h4><span class="vc_sep_holder vc_sep_holder_r"><span  class="vc_sep_line"></span></span>
                                                    ...
                                                    </div></div><div class="vc_tta-panel" id="1447164769737-a91a091c-c08e" data-vc-content=".vc_tta-panel-body"><div class="vc_tta-panel-heading"><h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="#1447164769737-a91a091c-c08e" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Chemical Dependency Treatment</span><i class="vc_tta-controls-icon vc_tta-controls-icon-chevron"></i></a></h4></div><div class="vc_tta-panel-body">
                                                        <div class="wpb_text_column wpb_content_element " >
                                                            <div class="wpb_wrapper">
                                                    ...
                                                    </div></div><div class="vc_tta-panel" id="1447164770280-9b737dde-f428" data-vc-content=".vc_tta-panel-body"><div class="vc_tta-panel-heading"><h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="#1447164770280-9b737dde-f428" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Physical Therapy</span><i class="vc_tta-controls-icon vc_tta-controls-icon-chevron"></i></a></h4></div><div class="vc_tta-panel-body">
                                                        <div class="wpb_text_column wpb_content_element " >
                                                            <div class="wpb_wrapper">
                        ...
                        <div class="wpb_column vc_column_container col-sm-4">
                            <div class="wpb_wrapper">
                                ...
                                </div><div role="form" class="wpcf7" id="wpcf7-f281-p611-o1" lang="en-US" dir="ltr">
                                    <div class="screen-reader-response"></div>
                                    <form action="/healthflex/departments/cosmetic-surgery/#wpcf7-f281-p611-o1" method="post" class="wpcf7-form demo" novalidate="novalidate">
                                        <div style="display: none;">
                                            <input type="hidden" name="_wpcf7" value="281" />
                                            <input type="hidden" name="_wpcf7_version" value="5.1.6" />
                                            <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                            <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f281-p611-o1" />
                                        ...
                                        <p><span class="wpcf7-form-control-wrap birthdate"><input type="date" name="birthdate" value="" class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date" aria-required="true" aria-invalid="false" placeholder="Date of Birth" /></span></p>
                                        <p><span class="wpcf7-form-control-wrap sex"><select name="sex" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false"><option value="Sex">Sex</option><option value="Female">Female</option><option value="Male">Male</option><option value="Child">Child</option></select></span> </p>
                        ...
                        <div class="wpb_column vc_column_container col-sm-12">
                            <div class="wpb_wrapper">
                                <div class="section_header subtitle_bottom   fancy text-center">
                                    ...
                                    <h2>Head of Department and Staff</h2>


                                    <p >A powerfull team working for your Health</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="team_member teaser_box centered same_height_col skincolored_section">
                                            ...
                                            <div class="content boxed  with_button ">
                                                ...
                                                <div class="link">
                                                    <a href="https://plethorathemes.com/healthflex/blog/profile/ben-folklore/" data-colorset="skincolored_section" class="linkify btn btn-xs btn-secondary">More</a>
                                                </div>
