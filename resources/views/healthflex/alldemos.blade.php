                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="/">Home</a></li>
                            ...
                            <li id="menu-item-1672" class="two-column dropleft menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1672 lihasdropdown"><a title="More" href="#">More  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1816" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-1816 active"><a title="All Other Demos &lt;span class=&quot;label label-danger&quot;&gt; NEW! &lt;/span&gt;" target="_blank" href="/all-demos/">All Other Demos <span class="label label-danger"> NEW! </span></a></li>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="teaser_box wpb_content_element text-center      with_button  medical_conference  ">
                                                ...
                                                <div class="figure ">
                                                    ...
                                                    <a href="/conference/" debug title="VISIT DEMO" target="">
                                                ...
                                                <div class="content text-center boxed  with_button ">
                                                    ...
                                                    <div class="link centered">
                                                        <a href="/conference/" VISIT DEMO target="" class="btn btn-xs btn-default"><strong>VISIT DEMO</strong></a>
                                                    </div>
