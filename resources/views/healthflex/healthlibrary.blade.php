...
@section('content')
    <body class="page-template-default page page-id-284 theme-healthflex woocommerce-no-js wpb-js-composer js-comp-ver-6.1 vc_responsive sticky_header ">
    <div class="overflow_wrapper">
                        ...
                        <ul id="menu-primary-menu" class="main_menu hover_menu"><li id="menu-item-1789" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1789"><a title="Home" href="https://plethorathemes.com/healthflex/">Home</a></li>
                            ...
                            <li id="menu-item-1674" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1674 lihasdropdown"><a title="Info" href="#">Info  </a>
                                <ul role="menu" class=" menu-dropdown">
                                    ...
                                    <li id="menu-item-1761" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-284 current_page_item menu-item-1761 active"><a title="Health Library A-Z" href="https://plethorathemes.com/healthflex/health-library/">Health Library A-Z</a></li>
        ...
        <div class="head_panel">
            <div style="background-image: url(https://plethorathemes.com/healthflex/wp-content/uploads/2015/09/slider-9.jpg)" class="full_width_photo   ">
                ...
                <div class="hgroup">
                    ...
                    <div class="title diagonal-bgcolor-trans   ">
                        <div class="container">
                            <h1>OUR HEALTH KNOWLEDGE BASE</h1>
                        </div>
                    </div>

                    <div class="subtitle body-bg_section   ">
                        <div class="container">
                            <p>Curated by our Doctors and Staff!</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="wpb_column vc_column_container col-sm-12">
                            <div class="wpb_wrapper">
                                <div class="knowledgebase  el_class">
                                    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3"><aside id="nav_menu-2" class="widget widget_nav_menu"><h4>Quick Links</h4><div class="menu-quick-links-container"><ul id="menu-quick-links" class="menu"><li id="menu-item-1784" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1784"><a href="https://plethorathemes.com/healthflex/services/">All Medical Services</a></li>
                                    ...
                                    <li id="menu-item-1788" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-284 current_page_item menu-item-1788"><a href="https://plethorathemes.com/healthflex/health-library/" aria-current="page">Health Library A-Z</a></li>
